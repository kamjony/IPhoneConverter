...
class tempViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        userConver[0] = UserDefaults.standard.object(forKey: "Temp1") as! String
        userConver[1] = UserDefaults.standard.object(forKey: "Temp2") as! String
        userConver[2] = UserDefaults.standard.object(forKey: "Temp3") as! String
        userConver[3] = UserDefaults.standard.object(forKey: "Temp4") as! String
        userConver[4] = UserDefaults.standard.object(forKey: "Temp5") as! String
...
//        }
    ...
    @IBAction func saveAction(_ sender: UIBarButtonItem) {
        ...
        let centValue = (self.tf1.text! as NSString).floatValue
        let farenValue = (self.tf2.text! as NSString).floatValue
        let kelValue = (self.tf3.text! as NSString).floatValue
        
        Saveinput(input: "\(centValue) °C = \(farenValue) °F = \(kelValue) K")
        
        UserDefaults.standard.set(userConver[0], forKey: "Temp1")
        UserDefaults.standard.set(userConver[1], forKey: "Temp2")
        UserDefaults.standard.set(userConver[2], forKey: "Temp3")
        UserDefaults.standard.set(userConver[3], forKey: "Temp4")
        UserDefaults.standard.set(userConver[4], forKey: "Temp5")
    ...
    @IBAction func celsiusChanged(_ sender: UITextField) {
        ...
        let centValue = (self.tf1.text! as NSString).floatValue
        let farenValue = Double(centToFar(cent: centValue)).roundToDecimal(4)
        let kelValue = Double(centValue + 273.15).roundToDecimal(4)
        
        self.tf2.text = "\(farenValue)"
        self.tf3.text = "\(kelValue)"
    ...
    @IBAction func fahrenheitChanged(_ sender: UITextField) {
        ...
        let farenValue = (self.tf2.text! as NSString).floatValue
        let centValue = Double(farToCent(far: farenValue)).roundToDecimal(4)
        let kelValue = Double(centValue + 273.15).roundToDecimal(4)
        self.tf3.text = "\(kelValue)"
        self.tf1.text = "\(centValue)"
...
//
    ...
    @IBAction func kelvinChanged(_ sender: UITextField) {
        ...
        let kelValue = (self.tf3.text! as NSString).floatValue
        let centValue = Double(kelValue - 273.15).roundToDecimal(4)
        let farenValue = Double(centToFar(cent: Float(centValue))).roundToDecimal(4)
        self.tf1.text = "\(centValue)"
        self.tf2.text = "\(farenValue)"
...
//
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let vcc = segue.destination as? historyViewController {
            ...
            let temp1 = UserDefaults.standard.object(forKey: "Temp1") ?? [String]()
            let temp2 = UserDefaults.standard.object(forKey: "Temp2") ?? [String]()
            let temp3 = UserDefaults.standard.object(forKey: "Temp3") ?? [String]()
            let temp4 = UserDefaults.standard.object(forKey: "Temp4") ?? [String]()
            let temp5 = UserDefaults.standard.object(forKey: "Temp5") ?? [String]()
